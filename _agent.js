...
6246 /agent/plugin/lang/oc/oc.js.map
5556 /agent/plugin/lang/oc/oc.js
...
10 /agent/types.js
6765 /agent/utils.js.map
7271 /agent/utils.js
✄
{"version":3,"file":"index.js","sourceRoot":"/Users/lzy/git_projects/IOSUtils/","sources":["agent/index.ts"],"names":[],"mappings":"AAAA,OAAO,cAAc,CAAA;AACrB,OAAO,aAAa,CAAA;AAMpB,UAAU,CAAC,CAAC,GAAG,GAAG,EAAE;IAChB,WAAW,CAAC,SAAS,EAAE,CAAA;AAC3B,CAAC,CAAA"}
✄
import './include.js';
import './logger.js';
globalThis.d = () => {
...
const showSubClasses = (ptr) => {
    ...
    getCachedClasses()
        ...
        if (sup == undefined || sup == null)
            return false;
        if (sup.$className == cur.$className)
            return true;
        return false;
    })
