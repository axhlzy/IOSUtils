...
1747 /agent/plugin/breaker/breaker.js.map
1638 /agent/plugin/breaker/breaker.js
...
281 /agent/plugin/include.js.map
185 /agent/plugin/include.js
...
16063 /agent/plugin/lang/oc/oc.js.map
17677 /agent/plugin/lang/oc/oc.js
180 /agent/plugin/lang/oc/types/include.js.map
26 /agent/plugin/lang/oc/types/include.js
6981 /agent/plugin/lang/oc/types/objc_method.js.map
7942 /agent/plugin/lang/oc/types/objc_method.js
...
10 /agent/types.js
13649 /agent/utils.js.map
13624 /agent/utils.js
✄
{"version":3,"file":"index.js","sourceRoot":"/Users/lzy/git_projects/IOSUtils/","sources":["agent/index.ts"],"names":[],"mappings":"AAAA,OAAO,cAAc,CAAA;AACrB,OAAO,aAAa,CAAA;AAEpB,cAAc;AACd,gBAAgB;AAChB,oBAAoB;AAEpB,gDAAgD;AAEhD,4FAA4F;AAC5F,sBAAsB;AACtB,+CAA+C;AAC/C,qDAAqD;AACrD,oDAAoD;AACpD,8FAA8F;AAC9F,QAAQ;AACR,KAAK;AAEL,mGAAmG;AAEnG,qBAAqB;AAErB,WAAW;AACX,0CAA0C;AAE1C,2DAA2D;AAC3D,uFAAuF;AAEvF,2DAA2D;AAC3D,wEAAwE;AAExE,wDAAwD;AAIxD,0BAA0B;AAC1B,sEAAsE;AACtE,wDAAwD;AACxD,+DAA+D;AAC/D,qDAAqD;AACrD,iEAAiE;AACjE,4EAA4E;AAC5E,+CAA+C;AAC/C,QAAQ;AAER,sDAAsD;AACtD,4FAA4F;AAC5F,kEAAkE;AAClE,oFAAoF;AACpF,wDAAwD;AACxD,sEAAsE;AACtE,qBAAqB;AACrB,4CAA4C;AAE5C,0BAA0B;AAC1B,+DAA+D;AAC/D,sBAAsB;AACtB,uCAAuC;AACvC,6CAA6C;AAC7C,4DAA4D;AAC5D,gDAAgD;AAEhD,qBAAqB;AAGrB,mBAAmB;AACnB,gDAAgD;AAEhD,6CAA6C;AAC7C,sEAAsE;AACtE,uEAAuE;AACvE,YAAY;AACZ,wBAAwB;AACxB,SAAS;AACT,wBAAwB;AACxB,wCAAwC;AACxC,SAAS;AACT,KAAK;AAEL,oBAAoB;AACpB,yDAAyD;AACzD,+BAA+B;AAC/B,kDAAkD;AAClD,wCAAwC;AACxC,YAAY;AAEZ,+BAA+B;AAC/B,2BAA2B;AAC3B,yCAAyC;AACzC,uCAAuC;AAEvC,6BAA6B;AAC7B,wBAAwB;AACxB,mFAAmF;AAEnF,uCAAuC;AACvC,sDAAsD;AACtD,8EAA8E;AAC9E,uDAAuD;AAEvD,yEAAyE;AACzE,6EAA6E;AAC7E,iGAAiG;AACjG,iIAAiI;AACjI,mCAAmC;AACnC,gCAAgC;AAChC,gGAAgG;AAChG,kCAAkC;AAClC,8BAA8B;AAE9B,kDAAkD;AAClD,qCAAqC;AACrC,qGAAqG;AACrG,qIAAqI;AACrI,wBAAwB;AACxB,uCAAuC;AACvC,qGAAqG;AACrG,uBAAuB;AACvB,oBAAoB;AAEpB,sBAAsB;AACtB,uDAAuD;AACvD,YAAY;AAEZ,4BAA4B;AAC5B,QAAQ;AACR,IAAI;AAEJ,qBAAqB"}
✄
import './include.js';
import './logger.js';
// hook_exit()
...
✄
{"version":3,"file":"breaker.js","sourceRoot":"/Users/lzy/git_projects/IOSUtils/","sources":["agent/plugin/breaker/breaker.ts"],"names":[],"mappings":"AAAA,OAAO,EAAE,OAAO,EAAE,MAAM,gBAAgB,CAAA;AAIxC,MAAM,OAAO;IAET,0BAA0B;IACnB,MAAM,CAAC,UAAU,CAAC,IAAqC,EAAE,eAAuB,CAAC;QACpF,IAAI,WAAW,CAAC,eAAe,CAAC,YAAY,CAAC,IAAI,CAAkB,CAAC,CAAC,MAAM,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC,SAAS,EAAE,IAAI,EAAE,YAAY,CAAC,CAAA;IAC5H,CAAC;IAED,wBAAwB;IACjB,MAAM,CAAC,YAAY,CAAC,IAAqC;QAC5D,IAAI,WAAW,CAAC,IAAI,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC,QAAQ,EAAE,IAAI,CAAC,CAAA;IACtD,CAAC;IAED,0BAA0B;IACnB,MAAM,CAAC,WAAW,CAAC,IAAmD,EAAE,YAAoB,EAAE;QACjG,MAAM,QAAQ,GAAkB,YAAY,CAAC,IAAI,CAAC,CAAA;QAClD,MAAM,QAAQ,GAAG,IAAI,IAAI,CAAC,KAAK,CAAC,QAAQ,CAAC,CAAA,CAAC,YAAY;QACtD,OAAO,CAAC,UAAU,CAAC,QAAQ,EAAE,CAAC,MAAwB,EAAE,KAAK,EAAE,EAAE;YAC7D,MAAM,UAAU,GAAG,GAAG,IAAI,CAAC,gBAAgB,CAAC,MAAM,CAAC,QAAQ,CAAC,EAAE,CAAA;YAC9D,IAAI,UAAU,CAAC,QAAQ,CAAC,SAAS,CAAC;gBAAE,OAAO,CAAC,YAAY,CAAC,MAAM,CAAC,MAAM,CAAC,CAAA;YACvE,oFAAoF;QACxF,CAAC,CAAC,CAAA;IACN,CAAC;IAEM,MAAM,CAAC,UAAU,CAAC,GAAgB,EAAE,QAAkE;QACzG,GAAG,CAAC,WAAW,CAAC,OAAO,CAAC,CAAC,CAAC,EAAE;YACxB,IAAI,MAAyB,CAAA;YAC7B,IAAI,IAAmB,CAAA;YACvB,IAAI;gBACA,MAAM,GAAG,GAAG,CAAC,CAAC,CAAsB,CAAA;gBACpC,IAAI,GAAG,MAAM,CAAC,cAAc,CAAA;aAC/B;YAAC,OAAO,KAAK,EAAE;gBACZ,MAAM,QAAQ,GAAG,IAAI,CAAC,sBAAsB,EAAE,aAAa,CAAC,CAAC,CAAC,SAAS,CAAC,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAA;gBAC7F,MAAM,UAAU,GAAG,IAAI,CAAC,yBAAyB,EAAE,GAAG,EAAE,QAAQ,CAAC,CAAA;gBACjE,MAAM,GAAG,IAAI,IAAI,CAAC,MAAM,CAAC,UAAU,CAAQ,CAAA;gBAC3C,IAAI,GAAG,IAAI,CAAC,0BAA0B,EAAE,MAAM,CAAC,CAAA;aAClD;YACD,QAAQ,CAAC,MAAM,EAAE,IAAI,CAAC,CAAA;QAC1B,CAAC,CAAC,CAAA;IACN,CAAC;CACJ;AAOD,UAAU,CAAC,CAAC,GAAG,OAAO,CAAC,YAAY,CAAA;AACnC,UAAU,CAAC,CAAC,GAAG,OAAO,CAAC,WAAW,CAAA"}
✄
...
class Breaker {
    ...
    static attachClass(mPtr, filterStr = '') {
        ...
        Breaker.itorMethod(localObj, (method, _impl) => {
            ...
            if (methodName.includes(filterStr))
...
export {};
✄
{"version":3,"file":"include.js","sourceRoot":"/Users/lzy/git_projects/IOSUtils/","sources":["agent/plugin/include.ts"],"names":[],"mappings":"AAAA,OAAO,oBAAoB,CAAA;AAE3B,OAAO,yBAAyB,CAAA;AAChC,OAAO,wBAAwB,CAAA;AAC/B,OAAO,sBAAsB,CAAA;AAC7B,OAAO,sBAAsB,CAAA;AAC7B,OAAO,mBAAmB,CAAA"}
✄
...
export const packArgs = (arg, type) => {
    ...
    if (type == "class")
        return new ObjC.Object(arg).toString();
    if (type == "object")
        return new ObjC.Object(arg).toString();
    if (type == "selector")
 ...
 * @returns
 */
const parseType = (typeStr, toDisplay = true) => {
    const idByAlias = {
        'c': 'char',
        'i': 'int',
        's': 'int16',
...
OC_Hook_Status.mapSrcToNewImpl = new Map();
class objc_method_local {
    ...
    hook(hooktype = this.HookType, passPrivate = true, defaultArgsC = 6) {
        ...
        switch (hooktype) {
            ...
            case HK_TYPE.OBJC_REP:
                ...
                if (method == undefined)
                    return loge(`${this.address} -> ${this.sel} | Error: methodFHandle is NULL`);
