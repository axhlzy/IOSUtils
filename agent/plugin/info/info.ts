...
function app_meta_info(DEBUG: boolean) {
    console.log("")
    console.warn("--------------------------------")
...
function raw_app_info_plist(DEBUG: boolean) {
    console.log("")
    console.warn("--------------------------------")
...
function protected_resources_permissions(DEBUG: boolean) {
    console.log("")
    console.warn("-----------------------------------")
    ...
    for (var i = 0; i < permissionListArray.length; i++) {
        try {
            if (dictKeys.containsObject_(permissionListArray[i])) {
                ...
                console.log("Name     : " + (permissionListNameDict as any)[permissionListArray[i]])
                console.log("Details  : " + (permissionListDetailDict as any)[permissionListArray[i]])
...
function app_transport_security(DEBUG: boolean) {
    console.log("")
    console.warn("-----------------------------------")
...
function classes_potential_jailbreak_detection(DEBUG: boolean) {
    console.log("")
    console.warn("---------------------------------------------")
...
function methods_potential_jailbreak_detection(DEBUG: boolean) {
    console.log("")
    console.warn("---------------------------------------------")
